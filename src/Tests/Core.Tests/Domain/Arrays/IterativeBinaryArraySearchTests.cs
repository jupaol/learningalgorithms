...
{
	[TestClass]
	public class IterativeBinaryArraySearchTests
	{
		[TestMethod]
		public void It_should_search_the_array_using_binary_iterative_algorithm()
		{
			var fixture = new Fixture().Customize(new AutoMoqCustomization());
			var sut = fixture.Create<IterativeBinaryArraySearch>();
